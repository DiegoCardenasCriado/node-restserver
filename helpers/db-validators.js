...
const allowedColections = async( colection = '', collections = [] ) => {

    const includes = collections.includes( colection );
    if ( !includes ) {
        throw new Error(`The collection: '${ colection }' is not allowed. The allowed collections are: ${ collections }`)
    }
